...
5. Join the respecitve Repository in the Github Organization (you will be invited to join the organization, please accept the invitation and join the repository) ^[A footnote]
6. Prototype/Flowchart the UI using ChatGPT or any other tool (Figma, Miro, etc.)
7. Push *point 1, point 4, point 6.*
8. Create a private Slack channel in **OUR** Workspace and name it **Group {number}**
9. Make sure to have `pdf` and image formats: no `docx` 
